...
from tests.utils import load_env_vars_from_yaml


@pytest.fixture(scope="session", autouse=True)
def load_test_env_vars():
    load_env_vars_from_yaml(".env-vars-test.yaml")


class TestAppDatabaseExists:
    def test_app_database_exists_returns_true_if_schema_found(self):
    ...
    def test_app_database_exists_returns_false_if_schema_not_found(self):
    ...
    def test_app_database_exists_raises_if_exception(self):
...
class TestVerifyDatabase:
    ...
    def test_verify_database_succeeds_if_conn_succeeds_and_db_exists(
    ...
    @patch("medsearch_api.app.database.utils.create_app_user_engine")
    @patch("medsearch_api.app.database.utils.app_database_exists")
    def test_verify_database_raises_database_config_exception_if_db_not_found(
        self, mock_app_db_exists, mock_create_engine
    ):
    ...
    @patch("medsearch_api.app.database.utils.create_app_user_engine")
    def test_verify_database_raises_sqlalchemy_error(self, mock_create_engine):
    ...
    @patch("medsearch_api.app.database.utils.create_app_user_engine")
    def test_verify_database_raises_other_exception(self, mock_create_engine):
